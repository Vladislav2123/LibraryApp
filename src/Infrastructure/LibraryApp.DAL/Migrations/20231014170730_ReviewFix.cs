    ...
    public partial class ReviewFix : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReadUsersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReadedBooksId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookUser", x => new { x.ReadUsersId, x.ReadedBooksId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookUser_ReadedBooksId",
                table: "BookUser",
                column: "ReadedBooksId");
